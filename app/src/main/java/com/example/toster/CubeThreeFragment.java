...
public class CubeThreeFragment extends Fragment {
    ...
    private final String save_3X3 = "save3X3";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_cube_three, container, false);
        init();
        int key = 3;
        ...
        clikcFlag = true;
        lastTime.setText(shared.getString(save_3X3,"Последнее время\n00:00:00"));
                ...
                if(!isFingerDown) {
                    ...
                    if (stopWatch.isRunning()) {
                        ...
                        if (stopw.getText().toString() != "Последнее время\n00:00:00"){
                            edit.putString(save_3X3,"Последнее время\n"+stopw.getText().toString());
                            edit.apply();
                        }
    ...
    private void init(){
        shared = getActivity().getSharedPreferences("Cube3X3", Context.MODE_PRIVATE);
        stopw = view.findViewById(R.id.stopwatch);
        lastTime = view.findViewById(R.id.lastTime2);
